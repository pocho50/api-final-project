...
class TestIntegration(TestCase):
    ...
    def test_process_video(self):
        ...
        dir_scenes = len(os.listdir(os.path.join(settings.UPLOAD_FOLDER, 
                                    'deab000c5012b3e9dafe8262046a556c')))

        images_in_scenes = len(os.listdir(os.path.join(settings.UPLOAD_FOLDER, 
                                    'deab000c5012b3e9dafe8262046a556c', '0')))
